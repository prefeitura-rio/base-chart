...
helm install my-app oci://us-west1-docker.pkg.dev/SEU_PROJECT_ID/basic-chart/base-chart --version 0.1.0

# Deploy com configurações customizadas
helm install my-app oci://us-west1-docker.pkg.dev/SEU_PROJECT_ID/basic-chart/base-chart \
...
```bash
helm install web-app oci://us-west1-docker.pkg.dev/SEU_PROJECT_ID/basic-chart/base-chart \
...
2. Atualize: `helm upgrade my-app oci://us-west1-docker.pkg.dev/SEU_PROJECT_ID/basic-chart/base-chart --set istio.enabled=true`
